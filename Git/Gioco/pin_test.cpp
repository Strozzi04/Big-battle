...
int numerolettere;
bool vinto=false;
		cout<<"sappi che in questa modalita' le cofre indovianate nella posizione corretta saranno indicate in ";
		...
		cout<<" giallo "<<endl;
		SetConsoleTextAttribute(h, 7);
			cout<<"inserisci il numero delle cifre: ";
		cin>>numerolettere;
			...
			if(parola[i]==intput_parola[i]){
				...
				string g=" -11  ";
				g=intput_parola[i];
				lettere_nella_posizione_corretta+=g+"$"+" "+"in pos "+posizione+" "+";"+" ";
				cgiustev++;	
				parola[i]='R';
				intput_parola[i]='Z';
				posizione=" ";
			...
			SetConsoleTextAttribute(h, 7);
			cout<<"nel pin ci sono anche:"<<endl;
			SetConsoleTextAttribute(h, 14);
